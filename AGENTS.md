...
| Hostiles, weapons, threat director | `src/combat.js`; update ordering in `src/sim.js`; event-driven effects in `src/game.js` |
...
- Load scripts in dependency order: propulsion, combat, simulation, audio, HUD, game;
