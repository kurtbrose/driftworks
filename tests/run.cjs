...
for (const file of ['src/propulsion.js', 'src/combat.js', 'src/logistics.js', 'src/formations.js', 'src/sim.js', 'src/population.js', 'src/session.js', 'src/tactical/camera.js', 'src/audio.js', 'src/hud.js', 'src/game.js', 'tests/scenario.js', 'tests/population-tests.js', 'tests/tests.js']) {
